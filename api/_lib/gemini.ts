...
- "isPartial": true si fue abono parcial ("le aboné", "le di algo"), false si fue pago total ("cancelé", "ya quedamos a paz").
...
1. FUSIÓN DE "vendí" + número:
   ...
   - "vendí dos"   → llega como "22"   → interpreta como cantidad 2
   - "vendí tres"  → llega como "23"   → cantidad 3
   - "vendí cuatro"→ llega como "24"   → cantidad 4
   - "vendí cinco" → llega como "25"   → cantidad 5
