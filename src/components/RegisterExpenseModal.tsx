          ...
          <div className="flex-1 overflow-y-auto px-6 py-5 space-y-5">
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                className={cn(
                  'w-full h-14 px-4 rounded-xl text-sm font-medium border-2 outline-none transition-all',
                  isDarkMode
                    ? 'bg-[#2A2A2A] border-white/10 focus:border-red-500 text-[#FDFBF0] placeholder:text-white/30'
                    : 'bg-[#f8f8f5] border-[#f0f0ec] focus:border-red-400 placeholder:text-black/30'
                )}
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={cn(
                    'w-full h-14 pl-8 pr-4 rounded-xl text-sm font-medium border-2 outline-none transition-all',
                    isDarkMode
                      ? 'bg-[#2A2A2A] border-white/10 focus:border-red-500 text-[#FDFBF0] placeholder:text-white/30'
                      : 'bg-[#f8f8f5] border-[#f0f0ec] focus:border-red-400 placeholder:text-black/30'
                  )}
              ...
              <div className="grid grid-cols-3 gap-2">
                {CATEGORIES.map((c) => (
                  <button
                    ...
                    className={cn(
                      'py-2.5 px-3 rounded-xl text-sm font-bold flex items-center justify-center gap-1.5 transition-all border-2',
                      category === c.label
                        ? 'border-red-400 bg-red-500/10 text-red-500'
                        : isDarkMode
                          ? 'border-white/10 bg-[#2A2A2A] text-white/60'
                          : 'border-[#f0f0ec] bg-[#f8f8f5] text-black/50'
                    )}
                  >
                    <span>{c.emoji}</span>
